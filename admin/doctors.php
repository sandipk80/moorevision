                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="actions pull-right">
                                <button name="add-new-doctor" class="btn btn-primary" type="button" onclick="javascript:return addNewDoctor();"><i class="fa fa-plus-circle"></i> Add New Doctor</button>
                            </div>
                        </div>
...
function addNewDoctor(){
    location.href="<?php echo ADMIN_SITE_URL; ?>add-doctor.php";
    return false;
}
...
$(document).on("click", ".updateStatus", function (e) {
    ...
    if(confirm("Are you sure want to update the status of this doctor?")) {
        $.ajax({
            ...
            dataType: "json",
            method: "post",
            data: {id:id,st:status,tb:'doctors'},
            cache: false,
