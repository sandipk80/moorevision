...
include(LIB_PATH . 'admin/doctors/add-init.php');
    ...
    <div class="pageheader">
        ...
        <div class="breadcrumb-wrapper hidden-xs">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo ADMIN_SITE_URL;?>doctors.php">Doctors</a></li>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							<form method="post" action="" name="frmAddDoctor" id="frmAddDoctor" class="form-horizontal form-border" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="email" placeholder="Email Address" id="name" value="<?php echo $email; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
...
echo '<option value="'.$cat['id'].'">'.ucwords($cat['name']).'</option>';
                                ...
                                <div class="form-group btn-row">
                                    ...
                                    <input type="hidden" name="add-doctor" value="submit" />
